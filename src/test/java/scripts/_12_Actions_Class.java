...
//        Actions actions = new Actions(driver); // NOT NEEDED ANYMORE WE ADD IT TO BASE
 ...
 */
    ...
    public void moveToElementPractice2() {
        ...
        Waiter.pause(5); // not proper to use (i had to use because my connection is slow
...
//    actions.click(registerForIntroLink).perform();
    ...
    */
    ...
    public void clickHoldAndReleasePractice(){
        ...
        actions.clickAndHold(dragMeBox).pause(Duration.ofSeconds(3)).moveToElement(dropHereBox).release().pause(Duration.ofSeconds(3)).perform();
